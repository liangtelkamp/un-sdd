...
class TestNonPIIClassifier:
    ...
    def test_classify_sensitivity_mapping(self, non_pii_classifier, mock_run_prompt, 
    ...
    def test_classify_with_different_versions(self, non_pii_classifier, mock_run_prompt):
    ...
    def test_classify_with_different_max_tokens(self, non_pii_classifier, mock_run_prompt):
    ...
    def test_classify_context_passing(self, non_pii_classifier, mock_run_prompt):
        ...
        table_context = "Demographic data table with age, gender, and location information"
    ...
    def test_classify_mixed_case_sensitivity_keywords(self, non_pii_classifier, mock_run_prompt):
    ...
    def test_classify_partial_keyword_matching(self, non_pii_classifier, mock_run_prompt):
    ...
    @pytest.mark.parametrize("table_context,isp,expected_behavior", [
        ("", "", "calls _run_prompt"),
    ...
    def test_classify_various_inputs(self, non_pii_classifier, mock_run_prompt, 
    ...
    def test_classify_special_characters_in_inputs(self, non_pii_classifier, mock_run_prompt):
