...
class TestAzureOpenAIStrategy:
    ...
    def test_azure_strategy_initialization_success(self, mock_dotenv, mock_azure_openai, mock_azure_config):
    ...
    def test_azure_strategy_initialization_from_env(self, mock_dotenv, mock_azure_openai):
    ...
    @patch('llm_model.azure_strategy.AzureOpenAI')
    @patch('llm_model.azure_strategy.dotenv.load_dotenv')
    def test_azure_strategy_initialization_exception(self, mock_dotenv, mock_azure_openai, mock_azure_config):
    ...
    @patch('llm_model.azure_strategy.AzureOpenAI')
    @patch('llm_model.azure_strategy.dotenv.load_dotenv')
    def test_generate_standard_model(self, mock_dotenv, mock_azure_openai, mock_azure_config, mock_openai_response):
    ...
    @patch('llm_model.azure_strategy.AzureOpenAI')
    @patch('llm_model.azure_strategy.dotenv.load_dotenv')
    def test_generate_o3_model(self, mock_dotenv, mock_azure_openai, mock_azure_config, mock_openai_response_o3):
    ...
    @patch('llm_model.azure_strategy.AzureOpenAI')
    @patch('llm_model.azure_strategy.dotenv.load_dotenv')
    def test_generate_with_exception(self, mock_dotenv, mock_azure_openai, mock_azure_config):
    ...
    @patch('llm_model.azure_strategy.AzureOpenAI')
    @patch('llm_model.azure_strategy.dotenv.load_dotenv')
    def test_different_model_versions(self, mock_dotenv, mock_azure_openai, mock_azure_config):
...
class TestAzureOpenAIStrategyIntegration:
    ...
    def test_full_workflow(self, mock_dotenv, mock_azure_openai):
        ...
        # Generate text
        result = strategy.generate("What is the capital of France?", temperature=0.7, max_new_tokens=50)
