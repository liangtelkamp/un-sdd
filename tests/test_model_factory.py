...
class TestModelFactory:
    ...
    def test_create_deepseek_model(self, mock_openai_strategy):
        ...
        # Assert
        mock_openai_strategy.assert_called_once_with("deepseek-ai/DeepSeek-R1-0528", None)
        assert model == mock_instance
    ...
    def test_create_unsloth_model(self, mock_unsloth_strategy):
        ...
        # Assert
        mock_unsloth_strategy.assert_called_once_with("unsloth/gemma-3-12b-it-bnb-4bit", None)
        assert model == mock_instance
