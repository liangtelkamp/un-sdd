...
class TestPIIReflectionClassifier:
    ...
    def test_classify_undetermined_output(
        self, pii_sensitivity_classifier, mock_run_prompt
    ):
    ...
    def test_classify_run_prompt_exception(
        self, pii_sensitivity_classifier, mock_run_prompt
    ):
    ...
    def test_classify_various_pii_entities(
        self, pii_sensitivity_classifier, mock_run_prompt, pii_entity, expected_behavior
    ):
